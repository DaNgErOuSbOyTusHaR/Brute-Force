# /bin/python !
# https://github.com/dangerousboytushar
...
\033[1;91m<═══\033[1;41m\033[1;97m Created by TEAM DANGEROUS \033[;0m\033[1;91m═══>\033[1;92m""")
...
\033[1;91m[\033[1;97m?\033[1;91m]\033[1;92m Features Of Bruteforce:
...
\033[1;97m➤ \033[1;92mTool Bruteforce is created by TEAM DANGEROUS
\033[1;92m""")
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://instagram.com/tusharhosennayem")
				...
				time.sleep(1)
				os.system("xdg-open https://github.com/dangerousboytushar")
